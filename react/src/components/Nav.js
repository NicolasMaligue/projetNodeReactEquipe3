      ...
      <>
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark" aria-label="Fifth navbar example">
          <div className="container-fluid">
            <a className="navbar-brand" href="/">FunTeam</a>
            ...
            <div className="collapse navbar-collapse" id="navbarsExample05">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item px-3"><NavLink to="/"><button className="btn btn-light">Dashboard</button></NavLink></li>
                <li className="nav-item px-3"><NavLink to="/quotes"><button className="btn btn-light">Devis</button></NavLink></li>

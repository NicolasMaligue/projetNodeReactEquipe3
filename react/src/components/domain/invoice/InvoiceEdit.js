            ...
            <div className="container">
                ...
                <form className="d-flex row gap-3" onSubmit={handleSubmit}>
                    <table
                        ...
                        <tbody>
                        <tr>
                            <th scope="row" className="col-4">N° de la facture
                            </th>
                            <td><input className="text-center" type="number"
                                       required min="0" value={invoice_id}
                                       onChange={(e) => setInvoiceId(
                                           e.target.value)}></input></td>
                        </tr>
                        <tr>
                            <th scope="row">N° de la commande</th>
                            <td><input className="text-center" type="number"
                                       required min="0" value={order_id}
                    ...
                    <button className="btn btn-danger"
                            onClick={() => {navigate(api_path-1, {replace:true});}}>Annuler
                    </button>
                </form>
            </div>
        </div>
